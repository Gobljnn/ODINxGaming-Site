...
namespace OdinXSiteMVC2.Controllers
{
    ...
    public class AdminoldController : Controller
    {
        ...
        public AdminoldController(OdinXSiteMVC2Context mySqlDb, ApplicationDbContext authDb, RoleManager<IdentityRole> roleManager, UserManager<ApplicationUser> userManager)
        {
            _mySqlDb = mySqlDb;
            _authDb = authDb;
        ...
        public async Task<IActionResult> Edit(string id)
        {
            ...
            ViewData["roleId"] = new SelectList(_authDb.Roles, "Id", "Name", user.bio);
            return View(user);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,firstName,lastName,UserName,Email,profilePic,gamerTag")] NewRegDTO newRegDTO)
        {
